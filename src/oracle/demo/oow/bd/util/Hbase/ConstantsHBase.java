...
public class ConstantsHBase {
	...
	public static String ZOOKEEPER = "lei";
	public static String HBASE_ROOT_DIR ="hdfs://lei:9000/hbase";
	public static String MYSQL_USERNAME = "root";
	public static String MYSQL_PASSWORD = "root";
	public static String MYSQL_DRIVER = "root";
	public static String MYSQL_URL = "root";
